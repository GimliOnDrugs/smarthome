...
function onDeviceAddClick() {
    ...
    var deviceDomToAdd = '<li class="list-group-item " id="' + uniqueID+ '"><div  ><div class=" row justify-content-center" style=" max-width: 1100px; margin-top: 20px;"><div class="col-auto col-center  "><p class="text-center d-block my-auto">Device Name</p></div><div class="col-4 col-center"><input class=" text-left d-block mx-auto my-auto form-control" id="device_name" type="text" placeholder="My Cool Device Name"></div><div class="col-auto col-center  "><div class="dropdown"><button class="btn btn-secondary dropdown-toggle" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="drop_'+uniqueID+'">Action</button><div class="dropdown-menu" aria-labelledby="dropdownMenuButton"><p class="dropdown-item" onclick="setActionLight('+uniqueID+')">Light</p><p class="dropdown-item" onclick="setActionVideo('+uniqueID+')">Video</p></div></div></div></div><div class="row justify-content-between" style="margin-top:50px;"><div class="col"></div><div class="col-auto col-center"><img class="fab" src="/css/assets/checked.svg" onclick="onOkClick('+uniqueID+')"></div><div class="col-auto col-center"><img class="fab" src="/css/assets/cancel.svg" onclick="onCancelClick('+uniqueID+')"></div><div class="col"></div></div></div></li>'
    var list = $('.list-group')
